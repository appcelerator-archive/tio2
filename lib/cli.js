...
program
	...
	.option('-a, --android-arch [arch]', 'the Android architecture to build with')
	.option('-o, --timeout [time]', 'set the timeout for running a Suite on Android')
...
var runner = new (require('./runner'))({
		...
		androidArch: program.androidArch,
		suiteTimeout: program.timeout
	}),
	startTime = Date.now();
