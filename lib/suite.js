...
Suite.prototype.runApp = function runApp(next) {
	...
	if (this.platform === 'android') {
		...
		function androidCallback(e){
			logger['tio2-error'](e);
		};

		var tiResults = "";
		function infoParser(line) {
			if (line === '!TI_MOCHA_RESULTS_START!' || line === ' !TEST_RESULTS_START!') {
				inTiMochaResult = true;
			} else if (inTiMochaResult && (line === '!TI_MOCHA_RESULTS_STOP!' || line === ' !TEST_RESULTS_STOP!')) {
